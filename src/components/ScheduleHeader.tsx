...
const ScheduleHeader: React.FC = () => {
  return <section id="schedule" className="pt-20 md:pt-32 pb-6 overflow-hidden">
      <div className="container mx-auto px-4">
        <h1 className="mb-8 text-center text-[3rem] sm:text-[5rem] md:text-[8rem] font-bold leading-none tracking-tighter text-white animate-fade-in lg:text-[12rem] px-px mx-0">WORKSHOP</h1>
