    ...
    <section id="schedule" className="pt-32 pb-6">
      <div className="container mx-auto px-4">
        ...
        <div className="relative w-full overflow-hidden bg-white py-2 mb-16">
          <div className="marquee-container flex w-fit animate-marquee">
            {Array(20).fill("WORKSHOP").map((text, index) => (
              <span key={index} className="mx-4 text-xl font-bold uppercase tracking-widest text-black whitespace-nowrap">
                {text}
              </span>
            ))}
          </div>
